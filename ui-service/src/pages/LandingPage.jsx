...
export default function LandingPage() {
    ...
    return (
        <div class="flex justify-center items-center p-10 bg-secondary/30 w-full min-h-screen">
            <div class="border border-tertiary-100/10 overflow-hidden relative shadow-xl rounded-md w-full h-full bg-primary p-10 py-20 flex flex-col justify-center items-center">
                ...
                <span class="text-5xl font-semibold text-secondary">Learn efficiently</span>
