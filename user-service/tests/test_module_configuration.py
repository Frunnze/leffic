...
from shared import database_settings, jwt_secret
...
def test_a_postgres_url_is_taken_from_the_environment() -> None:
    postgres_url = "postgresql://postgres:postgres@localhost:5432/users"

    with mock.patch.dict(os.environ, {"DATABASE_URL": postgres_url}):
        reloaded = importlib.reload(database_settings)
