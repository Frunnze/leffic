...
def test_returns_raw_text_for_non_json_answers() -> None:
    manager, _ = _manager([FakeResponse("plain words")])

    answer, _ = manager.get_ai_res(_SYSTEM_PROMPT, _USER_PROMPT, "TEXT")

    assert answer == "plain words"
...
def test_json_format_is_the_default_output() -> None:
